...
<<<<<<< HEAD
  ...
  ('term -> term TIMES factor','term',3,'p_term_times','sintactico.py',59),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','sintactico.py',63),
  ('term -> term POWER factor','term',3,'p_term_power','sintactico.py',67),
  ('term -> factor','term',1,'p_term_factor','sintactico.py',71),
  ('factor -> NUMBER','factor',1,'p_factor_number','sintactico.py',75),
  ('factor -> VARIABLE','factor',1,'p_factor_variable','sintactico.py',79),
  ('factor -> CONSTANT','factor',1,'p_factor_constant','sintactico.py',83),
  ('factor -> FUNCTION PAREN_OPEN arg_list PAREN_CLOSE','factor',4,'p_factor_function_with_args','sintactico.py',88),
  ('factor -> FUNCTION PAREN_OPEN PAREN_CLOSE','factor',3,'p_factor_function_no_args','sintactico.py',92),
  ('factor -> PAREN_OPEN expression PAREN_CLOSE','factor',3,'p_factor_paren','sintactico.py',96),
  ('factor -> MINUS factor','factor',2,'p_factor_unary_minus','sintactico.py',100),
